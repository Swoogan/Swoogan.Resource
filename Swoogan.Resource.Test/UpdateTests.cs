...
namespace Swoogan.Resource.Test
{
    ...
    {
        [TestMethod]
        public void Update_With_Body()
        {
            var client = new Mock<IRestClient>();
            var requester = new Mock<IRequester>();

            RestRequest request = null;
            requester.Setup(r => r.NewRequest(Method.PATCH)).Returns<Method>(m =>
            {
            ...
            var response = res.Update(customer);
        ...
        [TestMethod]
        public void Update_With_Params()
        {
            var client = new Mock<IRestClient>();
            var requester = new Mock<IRequester>();
        ...
        [TestMethod]
        public void Update_Without_Body()
        {
            var client = new Mock<IRestClient>();
            var requester = new Mock<IRequester>();
